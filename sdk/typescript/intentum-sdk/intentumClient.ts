...
/**
 * Instantiates a new {@link IntentumClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createIntentumClient(requestAdapter: RequestAdapter) {
    ...
    if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === null || requestAdapter.baseUrl === "") {
        requestAdapter.baseUrl = "https://api.intentum.dev";
    }
    const pathParameters: Record<string, unknown> = {
        "baseurl": requestAdapter.baseUrl,
    };
    return apiClientProxifier<IntentumClient>(requestAdapter, pathParameters, IntentumClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface IntentumClient extends BaseRequestBuilder<IntentumClient> {
    /**
     * The api property
     */
 ...
 */
export const IntentumClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const IntentumClientNavigationMetadata: Record<Exclude<keyof IntentumClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
