...
/// <summary>
/// Broadcasts Project Pulse step events to SSE clients.
/// </summary>
public sealed class ProjectPulseBroadcaster
{
    private static readonly JsonSerializerOptions JsonOptions = new() { PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
    private readonly ConcurrentDictionary<Guid, Channel<byte[]>> _clients = new();

    public void Broadcast(object projectPulseEvent)
    {
        var payload = JsonSerializer.SerializeToUtf8Bytes(projectPulseEvent, JsonOptions);
