...
/// <summary>
/// Azure OpenAI embedding provider. On 429 after retries throws <see cref="AzureOpenAIRateLimitException"/> with optional Retry-After; other non-2xx throw <see cref="HttpRequestException"/>.
    ...
    public IntentEmbedding Embed(string behaviorKey)
    {
        ...
        for (var attempt = 1; attempt <= maxAttempts; attempt++)
        {
            ...
            if (response.StatusCode == HttpStatusCode.TooManyRequests && attempt == maxAttempts)
            {
                ...
                response.Dispose();
                throw new AzureOpenAIRateLimitException(retryAfterSec, body);
            }
