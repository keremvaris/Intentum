...
/// Showcase for domain-specific Observe → Infer → Decide flows.
/// </summary>
public class SectorScenarioTests
{
    ...
    [Fact]
    public void ECommerce_AddToCart_AllowsOrObserves()
    {
        var space = new BehaviorSpace()
    ...
    [Fact]
    public void ECommerce_CheckoutSuccess_AllowsOrObserves()
    {
        var space = new BehaviorSpace()
            .Observe("user", "cart")
